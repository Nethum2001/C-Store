...
INSERT INTO "product" ("product_name", "base_price", "brand", "description", "image_url") VALUES
    ...
    ('Galaxy M04 phone',45000.00,'Samsung','One year software and hardware warranty AND the charger included','5/5_product.jfif'), 
    ...
    ('Electric Domino Train Toy',1300.00,'Lego','Colorful Electric Domino Train Toys Set with 100Pcs Building Blocks','25/25_product.jfif'), 
    ...
    ('Flying Disk spinning Gun',1549.00,'Kinsa','Flying Disc with ball bearing center that keeps on spinning Fun for all ages Improve eye-hand coordination','30/30_product.jfif'), -- description should be changed
